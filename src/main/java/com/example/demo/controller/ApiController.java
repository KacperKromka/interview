...
public class ApiController {
    ...
    @PostMapping("/send")
    public List<Message> send(@RequestBody Message newMessage){
    	int magicNumber = newMessage.getMagicNumber();
    ...
    public Slice<Message> page(@PathVariable String emailValue){
        return messageRepository.findMessagesByEmail(emailValue, CassandraPageRequest.of(0, 5));
    }
}
